...
test('should render a category name', () => {
    ...
    // When
    const component = shallow(<Categories categories={categories} categoriesCallback={jest.fn()}/>);
...
test('should emit to the categoriesCallback the category selected', () => {
    ...
    const component = shallow(<Categories categories={categories} categoriesCallback={categoriesCallback}/>);
